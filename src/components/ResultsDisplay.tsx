...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ result }) => {
  ...
  return (
    <div className="space-y-8 z-60 relative mb-10">
      <div className="relative text-center p-6 bg-see-bg rounded-lg border border-gray-200 shadow-sm">
        ...
        <p className="text-sm text-see-text-gray mt-2 mb-4">Calculado em: {result.calculatedOn}</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-see-blue leading-relaxed">
                      Como você já preenche os requisitos para se aposentar em pelo menos uma regra, você tem direito a receber o <strong>Abono de Permanência</strong> se optar por continuar trabalhando.
                      Este benefício corresponde ao valor da sua contribuição previdenciária.
                    </p>
                  </div>
                </div>
              </div>
