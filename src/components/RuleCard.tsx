...
import { RuleResult, RequirementStatus } from '../types/types';
...
const RuleCard: React.FC<RuleCardProps> = ({ rule, isClosest = false }) => {
    ...
    const cardBorderColor = rule.eligible ? 'border-see-green' : 'border-see-red';
    const headerBgColor = rule.eligible ? 'bg-see-green-light' : 'bg-see-red-light';
    const headerTextColor = rule.eligible ? 'text-see-green-dark' : 'text-see-red-dark';
